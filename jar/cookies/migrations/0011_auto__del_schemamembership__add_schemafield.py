...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SchemaMembership'
        db.delete_table(u'cookies_schemamembership')

        # Adding model 'SchemaField'
        db.create_table(u'cookies_schemafield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('schema', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cookies.Schema'])),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cookies.Field'])),
        ))
        db.send_create_signal(u'cookies', ['SchemaField'])


    def backwards(self, orm):
        # Adding model 'SchemaMembership'
        db.create_table(u'cookies_schemamembership', (
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cookies.Field'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('schema', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cookies.Schema'])),
        ))
        db.send_create_signal(u'cookies', ['SchemaMembership'])

        # Deleting model 'SchemaField'
        db.delete_table(u'cookies_schemafield')
    ...
    models = {
        ...
        u'cookies.corpus': {
            ...
            'contains': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'in_corpus'", 'symmetrical': 'False', 'to': u"orm['cookies.Resource']"}),
        ...
        u'cookies.schemafield': {
            'Meta': {'object_name': 'SchemaField'},
            'field': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cookies.Field']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'schema': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cookies.Schema']"})
        },
        u'cookies.textvalue': {
