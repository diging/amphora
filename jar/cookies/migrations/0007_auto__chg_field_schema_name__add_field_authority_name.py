...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Schema.name'
        db.alter_column(u'cookies_schema', 'name', self.gf('django.db.models.fields.CharField')(max_length=500))
        # Adding field 'Authority.name'
        db.add_column(u'cookies_authority', 'name',
                      self.gf('django.db.models.fields.CharField')(default='bob', max_length=500),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Schema.name'
        db.alter_column(u'cookies_schema', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Deleting field 'Authority.name'
        db.delete_column(u'cookies_authority', 'name')
