...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field contains on 'Corpus'
        m2m_table_name = db.shorten_name(u'cookies_corpus_contains')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('corpus', models.ForeignKey(orm[u'cookies.corpus'], null=False)),
            ('resource', models.ForeignKey(orm[u'cookies.resource'], null=False))
        ))
        db.create_unique(m2m_table_name, ['corpus_id', 'resource_id'])


    def backwards(self, orm):
        # Removing M2M table for field contains on 'Corpus'
        db.delete_table(db.shorten_name(u'cookies_corpus_contains'))
