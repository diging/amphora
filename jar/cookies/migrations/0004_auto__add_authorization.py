...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cookies_authorization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('actor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('to_do', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cookies.Action'])),
            ('on', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cookies.Entity'])),
        ))
        db.send_create_signal(u'cookies', ['Authorization'])


    def backwards(self, orm):
        # Deleting model 'Authorization'
        db.delete_table(u'cookies_authorization')
