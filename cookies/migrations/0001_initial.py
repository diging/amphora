# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2017-03-13 13:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concept', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='concepts.Concept')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cookies.Collection')),
            ],
        ),
        migrations.CreateModel(
            name='GilesToken',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='content_in_giles_sessions', to='cookies.Resource'),
        ),
        migrations.AddField(
            model_name='gilessession',
            name='created_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='giles_sessions', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='gilessession',
            name='resources',
            field=models.ManyToManyField(related_name='giles_sessions', to='cookies.Resource'),
        ),
        migrations.AddField(
            model_name='field',
            name='domain',
