...
urlpatterns = patterns('',
    ...
    url(r'^resource/bulkactionresource/$', views.bulk_action_resource, name="bulk-action-resource"),
    url(r'^resource/addresourcetocollection/$', views.bulk_add_resource_to_collection, name="bulk-add-resource-to-collection"),
