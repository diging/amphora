...
from .forms import *
from .models import *
from .ingest import ZoteroRDFIngester
from .admin import import_schema
#
...
#        self.list_url = reverse("admin:cookies_resource_changelist")
#
#        self.resource = Resource(name='TestResource')
#        self.resource.save()
#    
#        self.change_url = reverse("admin:cookies_resource_change", args=(self.resource.id,))
#    
...
#                'Returns no AdminForm'  )
#        self.assertEqual(response.context['adminform'].form.Meta.model,
#                Resource, 'Returns incorrect Form'    )
#
...
#            }
#
#        response = self.c.post(self.change_url, data)
#
#        self.assertIsInstance(response, HttpResponseRedirect,
#                'Returns incorrect response'    )
#        self.assertEqual(response.url, self.url_prefix + self.list_url,
...
#            'schema_url': 'http://devo-evo.lab.asu.edu/jars/dcterms.rdf',
...
class IngestZoteroRDF(TestCase):
    def setUp(self):
        ...
        self.fp = open("/Users/erickpeirson/Documents/TestRDF.zip", "r")
        import_schema("http://www.w3.org/1999/02/22-rdf-syntax-ns.rdf", "RDF")
        import_schema("http://dublincore.org/2012/06/14/dcelements.rdf", "DCElements")
        import_schema("http://dublincore.org/2012/06/14/dcterms.rdf", "DCTerms")
        import_schema("http://vocab.org/biblio/schema.rdf", "Biblio")
        import_schema("http://xmlns.com/foaf/spec/index.rdf", "FOAF")
