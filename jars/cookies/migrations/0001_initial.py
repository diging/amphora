    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uri', models.CharField(max_length=500, unique=True, null=True, blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('resource_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='cookies.Resource')),
                ('resources', models.ManyToManyField(related_name=b'part_of', null=True, to='cookies.Resource', blank=True)),
            ],
            options={
                'abstract': False,
            },
